...
namespace Wiimote_PPT
{
    public partial class BTUtil : Form
    {
        ...
        private void pairToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Wiiリモコンの裏蓋を開けて、電池の下にある「SYNC」ボタンを押してください。", "Wiimote", MessageBoxButtons.OK, MessageBoxIcon.Information);
            if (!bgWorker_devSearch.IsBusy)
                bgWorker_devSearch.RunWorkerAsync();
        }
        ...
        private void removeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("WiiリモコンはPCから正常に削除されました。", "Wiimote", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
