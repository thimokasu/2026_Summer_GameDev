...
#define SET_MOUSE(type,key)mouse[(int)type].emplace_back(key)
	...
	SET_C_OTHERS(KEY_TYPE::MOVE_RIGHT_SET, CONTROLLER_OTHERS::LEFTSTICK_RIGHT);
	SET_KEYBOARD(KEY_TYPE::MOVE_LEFT_SET, KEY_INPUT_LEFT);
	SET_C_OTHERS(KEY_TYPE::MOVE_LEFT_SET, CONTROLLER_OTHERS::LEFTSTICK_LEFT);

	SET_KEYBOARD(KEY_TYPE::SPACE, KEY_INPUT_SPACE);
	SET_C_BUTTON(KEY_TYPE::SPACE, XINPUT_BUTTON_A);
	...
	SET_KEYBOARD(KEY_TYPE::J_KEY_ACTION, KEY_INPUT_J);
	SET_C_BUTTON(KEY_TYPE::J_KEY_ACTION, XINPUT_BUTTON_B);
	SET_KEYBOARD(KEY_TYPE::K_KEY_ACTION, KEY_INPUT_K);
	SET_C_BUTTON(KEY_TYPE::K_KEY_ACTION, XINPUT_BUTTON_A);

	SET_KEYBOARD(KEY_TYPE::L_KEY_ACTOIN, KEY_INPUT_L);
